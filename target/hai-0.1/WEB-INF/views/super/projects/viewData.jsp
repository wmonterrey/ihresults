...
<spring:url value="/super/projects/editProject/{project}"	var="editUrl">
	<spring:param name="project" value="${project.idProyecto}" />
</spring:url>
<spring:url value="/super/projects/act/disable2/{project}" var="disableUrl">
	<spring:param name="project" value="${project.idProyecto}" />
</spring:url>
<spring:url value="/super/projects/act/enable2/{project}"	var="enableUrl">
	<spring:param name="project" value="${project.idProyecto}" />
</spring:url>
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							...
							<i class="fa fa-angle-right"></i> <a href="<spring:url value="/super/projects/" htmlEscape="true "/>"><spring:message code="superprojects" /></a> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/super/projects/viewProject/${project.idProyecto}" htmlEscape="true "/>">${project.idProyecto}</a>
						</li>
					</ul>
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
									<spring:url value="/super/projects/"	var="listProject"/>
									<button id="lista_projects" onclick="location.href='${fn:escapeXml(listProject)}'" class="btn btn-info">
									<spring:message code="superprojects" /> <i class="fa fa-reply"></i>
									</button>
								</div>
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu pull-right">
										...
										<c:choose>
											<c:when test="${project.pasive=='0'.charAt(0)}">
												<li>
													<a data-toggle="modal" data-project="${project.nombreProyecto}" data-id= "${fn:escapeXml(disableUrl)}" class="desact"><i class="fa fa-trash-o"></i> <spring:message code="disable" /></a>
												</li>
											</c:when>
											<c:otherwise>
												<li>
													<a data-toggle="modal" data-project="${project.nombreProyecto}" data-id= "${fn:escapeXml(enableUrl)}" class="act"><i class="fa fa-check"></i> <spring:message code="enable" /></a>
												</li>
											</c:otherwise>
										</c:choose>
									</ul>
							...
							<form class="form-horizontal">
								<div class="form-body">
									<h3 class="form-section"><spring:message code="idProyecto" />: <c:out value="${project.idProyecto}" /></h3>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message code="nombreProyecto" />:</label>
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${project.nombreProyecto}" />
													</p>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${project.recordUser}" />
													</p>
												</div>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-9">
													<p class="form-control-static">
														<c:out value="${project.recordDate}" />
													</p>
												</div>
											</div>
										</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-usd"></i><spring:message code="superaccounts" />
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="javascript:;" class="remove"></a>
						...
						<div class="portlet-body">
							...
							<table class="table table-striped table-hover table-bordered" id="lista_cuentas">
							<thead>
								<tr>
									<th class="hidden-xs"><spring:message code="idCuenta" /></th>
									<th><spring:message code="nombreCuenta" /></th>
									<th><spring:message code="enabled" /></th>
									<th><spring:message code="addedBy" /></th>
									<th><spring:message code="dateAdded" /></th>
								</tr>
							</thead>
							<c:forEach items="${cuentasproyecto}" var="cuenta">
								<tr>
									<spring:url value="/super/accounts/viewAccount/{account}"
										var="cuentaUrl">
										<spring:param name="account" value="${cuenta.cuenta.idCuenta}" />
									</spring:url>
									<td class="hidden-xs"><a href="${fn:escapeXml(cuentaUrl)}"><c:out value="${cuenta.cuenta.idCuenta}" /></a></td>
									<td><c:out value="${cuenta.cuenta.nombreCuenta}" /></td>
									<c:choose>
										<c:when test="${cuenta.cuenta.pasive=='0'.charAt(0)}">
...
<script>
	jQuery(document).ready(function() {
		...
		$('#lista_cuentas').DataTable({"oLanguage": {"sUrl": "${dataTablesLang}"}});
		...
		$(".act").click(function(){ 
        	...
        	$('#cuerpo').html('<h3>'+"${habilitar}"+' '+$(this).data('project')+'?</h3>');
        	$('#basic').modal('show');
        });
        ...
        $(".desact").click(function(){ 
        	$('#accionUrl').val($(this).data('id'));
        	$('#titulo').html('<h2 class="modal-title">'+"${confirmar}"+'</h2>');
        	$('#cuerpo').html('<h3>'+"${deshabilitar}"+' '+$(this).data('project')+'?</h3>');
        	$('#basic').modal('show');
        });
