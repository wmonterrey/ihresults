...
<spring:url value="/super/centers/editCenter/{center}"	var="editUrl">
	<spring:param name="center" value="${center.idCentro}" />
</spring:url>
<spring:url value="/super/centers/act/disable2/{center}" var="disableUrl">
	<spring:param name="center" value="${center.idCentro}" />
</spring:url>
<spring:url value="/super/centers/act/enable2/{center}"	var="enableUrl">
	<spring:param name="center" value="${center.idCentro}" />
</spring:url>
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							...
							<i class="fa fa-angle-right"></i> <a href="<spring:url value="/super/centers/" htmlEscape="true "/>"><spring:message code="supercenters" /></a> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/super/centers/viewCenter/${center.idCentro}" htmlEscape="true "/>">${center.idCentro}</a>
						</li>
					</ul>
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
									<spring:url value="/super/centers/"	var="listCenter"/>
									<button id="lista_centros" onclick="location.href='${fn:escapeXml(listCenter)}'" class="btn btn-info">
									<spring:message code="supercenters" /> <i class="fa fa-reply"></i>
									</button>
								</div>
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu pull-right">
										...
										<c:choose>
											<c:when test="${center.pasive=='0'.charAt(0)}">
												<li>
													<a data-toggle="modal" data-centro="${center.nombreCentro}" data-id= "${fn:escapeXml(disableUrl)}" class="desact"><i class="fa fa-trash-o"></i> <spring:message code="disable" /></a>
												</li>
											</c:when>
											<c:otherwise>
												<li>
													<a data-toggle="modal" data-centro="${center.nombreCentro}" data-id= "${fn:escapeXml(enableUrl)}" class="act"><i class="fa fa-check"></i> <spring:message code="enable" /></a>
												</li>
											</c:otherwise>
										</c:choose>
									</ul>
							...
							<form class="form-horizontal">
								<div class="form-body">
									<h3 class="form-section"><spring:message code="idCentro" />: <c:out value="${center.idCentro}" /></h3>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message code="nombreCentro" />:</label>
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${center.nombreCentro}" />
													</p>
												</div>
											</div>
										</div>
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							...
							<c:forEach items="${usuarioscentro}" var="usuario">
								<tr>
									<spring:url value="/admin/users/{username}"
										var="usuarioUrl">
										<spring:param name="username" value="${usuario.user.username}" />
									</spring:url>
									<td><a href="${fn:escapeXml(usuarioUrl)}"><c:out value="${usuario.user.username}" /></a></td>
									<td class="hidden-xs"><c:out value="${usuario.user.completeName}" /></td>
									<c:choose>
										<c:when test="${usuario.user.enabled}">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-archive"></i><spring:message code="superstudies" />
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="javascript:;" class="remove"></a>
						...
						<div class="portlet-body">
							...
							<thead>
								<tr>
									<th class="hidden-xs"><spring:message code="idEstudio" /></th>
							...
							<c:forEach items="${estudioscentro}" var="estudio">
								<tr>
									<spring:url value="/super/studies/viewStudy/{estudy}"
										var="estudioUrl">
										<spring:param name="estudy" value="${estudio.estudio.idEstudio}" />
									</spring:url>
									<td class="hidden-xs"><a href="${fn:escapeXml(estudioUrl)}"><c:out value="${estudio.estudio.idEstudio}" /></a></td>
									<td><c:out value="${estudio.estudio.nombreEstudio}" /></td>
									<c:choose>
										<c:when test="${estudio.estudio.pasive=='0'.charAt(0)}">
											<td><span class="label label-success"><spring:message code="yes" /></span></td>
										</c:when>
										<c:otherwise>
											<td><span class="label label-danger"><spring:message code="no" /></span></td>
...
<script>
	jQuery(document).ready(function() {
		...
		$('#lista_estudios').DataTable({"oLanguage": {"sUrl": "${dataTablesLang}"}});
